...
public class LombokTest {
    public static void main(String[] args) {
        ...
        // 2. 풀생성자로 객체 생성
        ConsoleDto consoleDto2 =
                new ConsoleDto( 0 , "공부", LocalDate.now() , true );
        ...
        //ConsoleDto consoleDto3 = new ConsoleDto( "공부" , true ); // 생성[정의]된 생성자만 사용할수 있다.
            // 2. 생성자는 매개변수의 순서가 다르면 오류가 발생...  // 매개변수 순서와타입 일치하지 않음.
        //ConsoleDto consoleDto4 = new ConsoleDto( true , "공부" , 0 , LocalDate.now() );

        // - 롬복이 있을때 DTO
        LombokDto lombokDto1 = new LombokDto();
        LombokDto lombokDto2 =
                new LombokDto( 0 , "공부", LocalDate.now() , true);
        ...
        LombokDto lombokDto4 = LombokDto.builder()
                .finished(true).title("공부")
                .dueDate( LocalDate.now()).tno(0)
                .build();
    }
}
