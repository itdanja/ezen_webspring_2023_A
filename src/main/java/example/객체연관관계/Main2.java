...
public class Main2 {
    public static void main(String[] args) {
        ...
        // 3. 관계  : 상위클래스[1] <------> 하위클래스[M]  : 1:M      하나의 여러개를 참조한다.
        //  A객체가 B/C객체를 참조한다.
        A객체.get참조하위객체들().add( B객체 ); // A객체내 B객체를 참조할수 있게 리스트에 담아준다.
        A객체.get참조하위객체들().add( C객체 ); // A객체내 C객체를 참조할수 있게 리스트에 담아준다.
        // !!! : A객체는 B/C객체를 참조할수 있다.
