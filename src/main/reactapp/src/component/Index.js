...
import 상태관리컴포넌트 from './example/day04/2_상태관리컴포넌트';
import 생명주기컴포넌트 from './example/day04/3_생명주기컴포넌트';
                    ...
                    <Routes >
                        ...
                        {/* EXAMPLE */}
                         <Route path='/example' element = { <ExampleList />} />
                            ...
                            <Route path='/example/day04/상태관리컴포넌트' element = { <상태관리컴포넌트 />} />
                            <Route path='/example/day04/생명주기컴포넌트' element = { <생명주기컴포넌트 />} />
                        {/* MEMBER */}
